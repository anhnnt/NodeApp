node {
	...
	stage('Run container on DevServer'){
		...
		sh label: '', script: 'ssh -oStrictHostKeyChecking=no -i /home/citeam/.ssh/id_ed25519.pub citeam@194.110.231.139 uptime \' docker run -p 8081:8000 -d --name test-jenkins sampleacc54/nodeapp1 \''
}
}
